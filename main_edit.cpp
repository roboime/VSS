...
void send_commands(int *vel){
    ...
    for(int i = 0 ; i < 3 ; i++){
        ...
        wheelsCommand.leftVel = 5;
        wheelsCommand.rightVel = 5;
...
void send_debug(){
    ...
    for(unsigned int i = 0 ; i < 3 ; i++){
        ...
        std::cout << "Estou imprimindo uma posicao" << std::endl;
...
int main(int , char** ){
    ...
    inet_aton("192.168.1.100", &addrF.sin_addr);
    ...
    inet_aton("192.168.1.100", &addrE.sin_addr);
  ...
  //  std::string bufReceiver;
    ...
    while(true){
      ...
      //  bufReceiver.clear();
        ...
        std::cout << "ANTES DE CHAMAR O DEBUG" << std::endl;
        send_debug();
